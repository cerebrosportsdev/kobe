...
Bar chart should only be used if there's categorical x-axes like wins and losses as x axis values. Otherwise mostly Scatter.
ONE ROW : If there's only one row, return {"requires_visual" = false} for now
